...
//    //=======【证书路径设置】=====================================
//    //证书路径,注意应该填写绝对路径
//    static $SSLCERT_PATH = '/xxx/xxx/xxxx/WxPayPubHelper/cacert/apiclient_cert.pem';
//    static $SSLKEY_PATH = '/xxx/xxx/xxxx/WxPayPubHelper/cacert/apiclient_key.pem';
//
//    //=======【异步通知url设置】===================================
...
//}
//class WxPay extends Common_util_pub{
//    private $config;
...
//        WxPayConfig::$MCHID=$config['mch_id'];
//        WxPayConfig::$KEY=$config['key'];
//        WxPayConfig::$APPSECRET=$config['appsecret'];
//        WxPayConfig::$SSLCERT_PATH = './'.$this->config['key'].'/pem/apiclient_cert.pem';
//        WxPayConfig::$SSLKEY_PATH = './'.$this->config['key'].'/pem/apiclient_key.pem';
//        WxPayConfig::$NOTIFY_URL = $config['notify_url'];
//        WxPayConfig::$CURL_TIMEOUT=  $config['curl_timeout']?$config['curl_timeout']:30;
//    }
//
//    public function get_pay_script($prepay_id){
//        $this->prepay_id=$prepay_id;
//        $jsApiParameters = $this->getParameters();
//        return 'var jsApiParameters=' . $jsApiParameters;
//    }
//
//
//    /**
...
//        $str='000000'.rand(1,10000);
//        return time().substr($str,-6);
//    }
//
...
//    }
//
//    public function return_error($info){
//        return array(
//            'status'=>false,
//            'info'=>$info
//        );
...
//     * 	作用：设置请求参数
//     */
//    function setParameter($parameter, $parameterValue){Log::record('parameters2=', json_encode($this->parameters));
...
//     * 生成接口参数xml
//     */
//    function createXml(){Log::record("aaaaaaaa" . json_encode($this->parameters, JSON_UNESCAPED_UNICODE));
//        try{
//            //检测必填参数
...
// * 关闭订单
// */
//class CloseOrder_pub  extends Common_util_pub
//{
//    var $parameters;//静态链接参数
//    var $url;//静态链接
//
...
//            if($this->parameters["out_trade_no"] == null)
//            {
//                throw new SDKRuntimeException("缺少关闭订单必填参数out_trade_no！"."<br>");
//            }
//            $this->parameters["appid"] = WxPayConfig::$APPID;//公众账号ID
//            $this->parameters["mch_id"] = WxPayConfig::$MCHID;//商户号
//            $this->parameters["nonce_str"] = $this->createNoncestr();//随机字符串
...
//    function createXml(){
//        try{
//            $this->parameters["wxappid"] = WxPayConfig::$APPID;//公众账号ID
//            $this->parameters["mch_id"] = WxPayConfig::$MCHID;//商户号
//            $this->parameters["mch_billno"] = $this->createOrderNo();//红包订单号
//            $this->parameters["nonce_str"] = $this->createNoncestr();//随机字符串
//            $this->parameters["client_ip"] = $this->get_ip();//ip地址
//            $this->parameters["sign"] = $this->getSign($this->parameters);//签名
//            return  $this->arrayToXml($this->parameters);
//        }catch (SDKRuntimeException $e){
//            die($e->errorMessage());
...
//     */
//    function send($openid,$money,$send_name,$wishing,$act_name,$remark,$total_num=1){
//        $this->parameters['send_name']=$send_name;
//        $this->parameters['re_openid']=$openid;
//        $this->parameters['total_amount']=$money*100;
...
//        }
//        $this->createXml();
//        $send_result=$this->getResult();
//        if($send_result['return_code']!='SUCCESS'){
//            return $this->return_error($send_result['return_msg']);
//        }else{
//            if($send_result['result_code']!='SUCCESS'){
//                return $this->return_error($send_result['err_code'].':'.$send_result['err_code_des']);
//            }else{
//                return true;
//            }
//        }
...
// * 发送普通红包
// */
//class SendRedpack_pub  extends Redpack_pub{
//    var $parameters;//静态链接参数
//    var $url;//静态链接
//
//    function __construct(){
...
//
//    function send($openid,$money,$send_name,$wishing,$act_name,$remark,$total_num=1){
//        return parent::send($openid,$money,$send_name,$wishing,$act_name,$remark);
//    }
//}
///**
// * 发送裂变红包
// */
//class SendGroupRedpack_pub  extends Redpack_pub{
//    var $parameters;//静态链接参数
//    var $url;//静态链接
//
//    function __construct(){
...
//
//    function send($openid,$money,$send_name,$wishing,$act_name,$remark,$total_num=1){
//        return parent::send($openid,$money,$send_name,$wishing,$act_name,$remark,$total_num);
//    }
//}
//
///**
// * 企业付款给个人
// */
//class PayUser_pub  extends Redpack_pub{
//    var $parameters;//静态链接参数
//    var $url;//静态链接
//
//    function __construct(){
...
//    function createXml(){
//        try{
//            $this->parameters["mch_appid"] = WxPayConfig::$APPID;//公众账号ID
//            $this->parameters["mchid"] = WxPayConfig::$MCHID;//商户号
//            $this->parameters["partner_trade_no"] = $this->createOrderNo();//红包订单号
//            $this->parameters["nonce_str"] = $this->createNoncestr();//随机字符串
//            $this->parameters["check_name"] ='NO_CHECK';//是否校验姓名
//            $this->parameters["spbill_create_ip"] = $this->get_ip();//ip地址
//            $this->parameters["sign"] = $this->getSign($this->parameters);//签名
//            return  $this->arrayToXml($this->parameters);
//        }catch (SDKRuntimeException $e){
//            die($e->errorMessage());
...
//    }
//
//    function send($openid,$money,$desc,$wishing=null,$act_name=null,$remark=null,$total_num=1){
//        $this->parameters["openid"] = $openid;//用户openid
//        $this->parameters["amount"] = $money*100;//付款金额
//        $this->parameters["desc"] =$desc;//企业付款操作说明信息
//        $this->createXml();
//        $send_result=$this->getResult();
//        if($send_result['return_code']!='SUCCESS'){
//            return $this->return_error($send_result['return_msg']);
