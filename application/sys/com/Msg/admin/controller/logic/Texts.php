...
namespace app\sys\com\Msg\admin\controller\logic;
 ...
 * @api_is_show 1
 * @api_is_def_name 0
 * @package app\sys\com\Msg\admin\controller\logic
 */
class Texts extends ControllerCommon {
    protected $_route_url = '/sys/admin/Msg.v1.{{$col}}.{{$act}}';
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Msg.v1.Texts.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Msg.v1.Texts.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Msg.v1.Texts.add
	 * 
	 * title			标题
	 * content			内容
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Msg.v1.Texts.edit
	 *
	 * id				
	 * title			标题
	 * content			内容
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Msg.v1.Texts.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Msg.v1.Texts.setStatus
	 *
	 * id				
	 * status			状态（0-未知 1-待发送 2-发送中 3-已发送）
	 * @return mixed|string
