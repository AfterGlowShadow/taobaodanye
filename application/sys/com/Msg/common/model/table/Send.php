...
namespace app\sys\com\Msg\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class Send extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_msg_send';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Msg';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Msg';
	}
