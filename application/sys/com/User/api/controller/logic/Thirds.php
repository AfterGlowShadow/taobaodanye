...
class Thirds extends ControllerCommon {
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 0
	 * @api_url /sys/api/User.v1.Thirds.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 0
	 * @api_url /sys/api/User.v1.Thirds.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 0
	 * @api_url /sys/api/User.v1.Thirds.add
	 * 
	 * uid					绑定用户uid
	 * openid				openid
	 * unionid				unionid
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 0
	 * @api_url /sys/api/User.v1.Thirds.edit
	 *
	 * id					
	 * uid					绑定用户uid
	 * openid				openid
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 0
	 * @api_url /sys/api/User.v1.Thirds.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 0
	 * @api_url /sys/api/User.v1.Thirds.setStatus
	 *
	 * id					
	 * status				状态（0-未知 1-绑定用户 2-未绑定 3-禁用）
	 * @return mixed|string
