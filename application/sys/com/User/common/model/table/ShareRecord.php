...
namespace app\sys\com\User\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class ShareRecord extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_user_share_record';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'User';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/User';
	}
