...
{{$class_comment}}
class {{$ClassName}} extends {{$ControllerCommon}} {
    protected $_route_url = '/{{$addon_url}}/admin/{{$component}}.{{$_ver}}.{{$col}}.{{$act}}';
...
{{$ListOrder}}
    ...
    /**
     * 获取详情 通过id查询{{$getItemById_comment}}
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
