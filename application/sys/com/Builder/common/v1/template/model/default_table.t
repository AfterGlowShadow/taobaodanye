...
use Exception;
{{$UseSoftDeleteNamespace}}

class {{$ClassName}} extends ModelCommon {
	{{$UseSoftDelete}}
	protected $field_prefix       = '{{$FieldPrefix}}';
	protected $pk                 = '{{$PK}}';
	protected $name               = '{{$TableName}}';
	protected $createTime         = {{$CreateTime}};
	protected $updateTime         = {{$UpdateTime}};
	protected $autoWriteTimestamp = {{$AutoWriteTimestamp}};
	protected $insert             = [
	...
	public function _init() {
		...
		$this->_pcmv['package'] = '{{$package}}';
		$this->_pcmv['component'] = '{{$component}}';
		$this->_pcmv['module'] = '{{$module}}';

		$this->_config_info['component_name'] = '{{$package}}/com/{{$component}}';
	}
