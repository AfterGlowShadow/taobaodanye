...
namespace app\sys\com\Vars\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class Vars extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_vars';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Vars';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Vars';
	}
