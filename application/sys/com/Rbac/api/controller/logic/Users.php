...
class Users extends LoginCommon {
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Rbac.v1.Users.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Rbac.v1.Users.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Rbac.v1.Users.add
	 * 
	 * name				用户名
	 * passwd			密码
	 * nickname			昵称
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Rbac.v1.Users.edit
	 *
	 * id				
	 * name				用户名
	 * passwd			密码
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Rbac.v1.Users.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Rbac.v1.Users.setStatus
	 *
	 * id				
	 * status			状态（1启用 0禁用）
	 * @return mixed|string
