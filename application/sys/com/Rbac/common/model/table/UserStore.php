...
namespace app\sys\com\Rbac\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;


class UserStore extends ModelCommon {
	
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_rbac_user_store';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Rbac';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Rbac';
	}
