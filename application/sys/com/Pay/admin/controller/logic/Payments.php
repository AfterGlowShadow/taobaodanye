...
class Payments extends ControllerCommon {
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Pay.v1.Payments.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Pay.v1.Payments.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Pay.v1.Payments.add
	 * 
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Pay.v1.Payments.edit
	 *
	 * id					
	 * title				标题（body subject）
	 * order_number			订单号
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Pay.v1.Payments.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Pay.v1.Payments.setStatus
	 *
	 * id					
	 * status				状态（0-未知 1-支付中 2-支付完成 3-支付失败 4-支付取消 5-退款中 6-退款完成 7-退款失败 8-退款取消）
	 * @return mixed|string
