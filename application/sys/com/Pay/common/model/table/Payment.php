...
namespace app\sys\com\Pay\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class Payment extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_pay_payment';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Pay';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Pay';
	}
