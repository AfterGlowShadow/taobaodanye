...
class Payment extends Validate {
	...
	protected $scene = [
		'add'  => ["title", "order_number", "out_trade_no", "realname", "identity_number", "money", "openid", "pay_type", "status", "remark", "tag", "attach", "notify_info", "pay_time"],
		'edit' => ["title", "order_number", "out_trade_no", "realname", "identity_number", "money", "openid", "pay_type", "status", "remark", "tag", "attach", "notify_info", "pay_time"],
	];
}
