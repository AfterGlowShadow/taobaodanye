...
namespace app\sys\com\Code\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class Sms extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_code_sms';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Code';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Code';
	}
