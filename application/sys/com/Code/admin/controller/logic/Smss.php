...
namespace app\sys\com\Code\admin\controller\logic;
 ...
 * @api_is_show 1
 * @api_is_def_name 0
 * @package app\sys\com\Code\admin\controller\logic
 */
class Smss extends ControllerCommon {
    protected $_route_url = '/sys/admin/Code.v1.{{$col}}.{{$act}}';
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Code.v1.Smss.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Code.v1.Smss.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Code.v1.Smss.add
	 * 
	 * mobile				手机
	 * code					短信验证码
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Code.v1.Smss.edit
	 *
	 * id					
	 * mobile				手机
	 * code					短信验证码
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Code.v1.Smss.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/admin/Code.v1.Smss.setStatus
	 *
	 * id					
	 * status				状态（0-未知 1-启用 2-禁用）
	 * @return mixed|string
