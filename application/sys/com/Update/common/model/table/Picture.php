...
namespace app\sys\com\Update\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;


class Picture extends ModelCommon {
	
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_update_picture';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Update';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Update';
	}
