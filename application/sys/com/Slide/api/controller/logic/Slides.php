...
namespace app\sys\com\Slide\api\controller\logic;
 ...
 * @api_is_show 1
 * @api_is_def_name 0
 * @package app\sys\com\Slide\api\controller\logic
 */
class Slides extends ControllerCommon {
    protected $_route_url = '/sys/api/Slide.v1.{{$col}}.{{$act}}';
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Slide.v1.Slides.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Slide.v1.Slides.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Slide.v1.Slides.add
	 * 
	 * title			标题
	 * intro			简介
	 * img				图片
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Slide.v1.Slides.edit
	 *
	 * id				
	 * title			标题
	 * intro			简介
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Slide.v1.Slides.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /sys/api/Slide.v1.Slides.setStatus
	 *
	 * id				
	 * status			状态（0-未知 1-启用 2-禁用）
	 * @return mixed|string
