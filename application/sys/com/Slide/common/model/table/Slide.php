...
namespace app\sys\com\Slide\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class Slide extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'sys_slide';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Slide';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'sys/com/Slide';
	}
