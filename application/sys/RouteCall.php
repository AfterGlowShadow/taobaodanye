...
class RouteCall {
    ...
    public function run(Request $request) {
        ...
        if ($this->_component && $this->col && $this->act) { // && $this->_ver
	        ...
	        // if (file_exists($initFile_miniapp = MINIAPP_PATH . 'init.php')) {
		    //     include_once $initFile_miniapp;
	        // }
	        //
	        // if (file_exists($initFile_mp = ADDON_PATH . 'init.php')) {
		    //     include_once $initFile_mp;
	        // }
            ...
            if (file_exists($filename)) {
                ...
                if ($_no_ver) {
	                ...
	                $class = '\\' . 'app' . '\\' . $this->addon . '\\' . $this->_com . '\\' . $this->_component . '\\' . $this->_type . '\controller\\' . ucfirst($this->col);
                } else {
	                include_once $_ver_path . DS . '/controller/' . ucfirst($this->col).'.php';
	                $class = '\\' . 'app' . '\\' . $this->addon . '\\' . $this->_com . '\\' . $this->_component . '\\' . $this->_type . '\\' . $this->_ver . '\controller\\' . ucfirst($this->col);
                }
