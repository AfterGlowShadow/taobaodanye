...
namespace app\app\yss\Yss\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class CategoryDetail extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'app_yss_category_detail';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Yss';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'app/com/Yss';
	}
