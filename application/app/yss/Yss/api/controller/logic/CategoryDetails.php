...
class CategoryDetails extends ControllerCommon {
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Yss.v1.CategoryDetails.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Yss.v1.CategoryDetails.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Yss.v1.CategoryDetails.add
	 * 
	 * name				分类值
	 * pid				上级id
	 * is_show			是否导航显示
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Yss.v1.CategoryDetails.edit
	 *
	 * id				
	 * name				分类值
	 * pid				上级id
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Yss.v1.CategoryDetails.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
