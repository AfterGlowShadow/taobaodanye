...
class Attributes extends ControllerCommon {
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.Attributes.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.Attributes.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.Attributes.add
	 * 
	 * ind_id			工商变更id
	 * cat_ids			属性id 中划线隔开
	 * cat_price		属性钱
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.Attributes.edit
	 *
	 * id				
	 * ind_id			工商变更id
	 * cat_ids			属性id 中划线隔开
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.Attributes.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
