...
class OrderDetails extends ControllerCommon {
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.OrderDetails.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.OrderDetails.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.OrderDetails.add
	 * 
	 * order_id				订单id
	 * type					类型
	 * company_type			企业类型
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.OrderDetails.edit
	 *
	 * id					
	 * order_id				订单id
	 * type					类型
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Yss.v1.OrderDetails.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
