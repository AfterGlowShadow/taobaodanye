...
class Combos extends ControllerCommon {
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Yss.v1.Combos.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Yss.v1.Combos.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Yss.v1.Combos.add
	 * 
	 * name				名称
	 * cat_ids			所有子分类id
	 * cat_names		所有子分类名
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Yss.v1.Combos.edit
	 *
	 * id				
	 * name				名称
	 * cat_ids			所有子分类id
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Yss.v1.Combos.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
