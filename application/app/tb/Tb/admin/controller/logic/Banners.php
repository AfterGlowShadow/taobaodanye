...
class Banners extends ControllerCommon {
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Tb.v1.Banners.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Tb.v1.Banners.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Tb.v1.Banners.add
	 * 
	 * url				轮播图地址(外网)
	 * goodsid			商品id
	 * img				图片地址
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Tb.v1.Banners.edit
	 *
	 * id				
	 * url				轮播图地址(外网)
	 * goodsid			商品id
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Tb.v1.Banners.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/admin/Tb.v1.Banners.setStatus
	 *
	 * id				
	 * status			状态（0-未知 1-启用 2-禁用）
	 * @return mixed|string
