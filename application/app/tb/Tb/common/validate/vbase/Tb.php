...
class Tb extends Validate {
	...
	protected $scene = [
		'add'  => ["order_sn", "user_id", "user_name", "product_name", "company_type", "company_type_name", "company_name", "city", "county", "phone", "credit_code", "pay_taxes", "pay_taxes_type", "declare_tax", "declare_tax_type", "recive_invoice", "internetbank", "bank_account", "bank_account_type", "sell_price", "qq", "status", "industry_type", "industry_name", "industry_second_type", "industry_second_name", "establishment", "registered_capital", "contributed_capital", "business_license", "legal_person", "business_scope", "other_infomation", "view_num", "celection_num", "publish_time"],
		'edit' => ["order_sn", "user_id", "user_name", "product_name", "company_type", "company_type_name", "company_name", "city", "county", "phone", "credit_code", "pay_taxes", "pay_taxes_type", "declare_tax", "declare_tax_type", "recive_invoice", "internetbank", "bank_account", "bank_account_type", "sell_price", "qq", "status", "industry_type", "industry_name", "industry_second_type", "industry_second_name", "establishment", "registered_capital", "contributed_capital", "business_license", "legal_person", "business_scope", "other_infomation", "view_num", "celection_num", "publish_time"],
	];
}
