...
namespace app\app\tb\Tb\common\model\table;

use app\sys\com\base\common\v1\logic\ModelCommon;
use Exception;
use think\model\concern\SoftDelete;

class Banner extends ModelCommon {
	use SoftDelete;
	protected $field_prefix       = '';
	protected $pk                 = 'id';
	protected $name               = 'app_tb_banner';
	...
	public function _init() {
		...
		$this->_pcmv['component'] = 'Tb';
		$this->_pcmv['module'] = 'common';

		$this->_config_info['component_name'] = 'app/com/Tb';
	}
