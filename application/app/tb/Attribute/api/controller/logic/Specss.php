...
class Specss extends ControllerCommon {
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Attribute.v1.Specss.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Attribute.v1.Specss.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Attribute.v1.Specss.add
	 * 
	 * name				规格名称
	 * classifyid		所属分类id
	 * classify			所属分类
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Attribute.v1.Specss.edit
	 *
	 * id				
	 * name				规格名称
	 * classifyid		所属分类id
	 ...
	 * @api_is_show 1
	 * @api_is_def_name 0
	 * @api_url /app/api/Attribute.v1.Specss.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
