...
class Classgoods extends ControllerCommon {
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Attribute.v1.Classgoods.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Attribute.v1.Classgoods.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Attribute.v1.Classgoods.add
	 * 
	 * classify			分类id
	 * goodsid			商品id
	 * @return mixed|string
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Attribute.v1.Classgoods.edit
	 *
	 * id				
	 * classify			分类id
	 * goodsid			商品id
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/api/Attribute.v1.Classgoods.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
