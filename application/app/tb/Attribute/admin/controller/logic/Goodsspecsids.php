...
class Goodsspecsids extends ControllerCommon {
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/admin/Attribute.v1.Goodsspecsids.getList
     *
     * page_num
     * page_limit
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/admin/Attribute.v1.Goodsspecsids.getItemById
     *
     * id
     * @return \think\response\Json
     * @throws \think\Exception
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/admin/Attribute.v1.Goodsspecsids.add
	 * 
	 * goods		商品id
	 * specsid		规格id
	 * @return mixed|string
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/admin/Attribute.v1.Goodsspecsids.edit
	 *
	 * id			
	 * goods		商品id
	 * specsid		规格id
	 ...
	 * @api_is_show 0
	 * @api_is_def_name 1
	 * @api_url /app/admin/Attribute.v1.Goodsspecsids.delete
     *
     * id
     * @return \think\response\Json
     * @throws \Throwable
