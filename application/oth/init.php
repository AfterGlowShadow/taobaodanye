...
function init_oth_com_component($dir) {
	$files = [];
...
function init_oth_autoload($classname) {
	$classpath = ROOT_PATH . "{$classname}.php";
	$classpath_com = LIB_OTH_PATH . "{$classname}.php";
...
spl_autoload_register('init_oth_autoload');

init_oth_com(LIB_PATH . 'oth/');